...
| [Fulton Plaza (147 Fulton Street)](./fulton-plaza.md) | `fulton-plaza` | 12.80 m (vertical extent — the asset is a terrain-draped right-of-way; the Pioneer Monument crest is 11.27 m above local grade) | new landmark |
