"""Fresh-scene contract validation for 400-brannan.glb.
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3946805, 37.7800981],
    ...
    results["checks"] = {
        "meters_and_plausible_dimensions": 8.6 <= dims.z <= 9.0
        and 29.5 <= dims.x <= 33.5
        and 31.5 <= dims.y <= 35.5,
