"""Compose the review renders into 400-brannan-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"400-brannan-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "400-brannan-contact-sheet.png"
    sheet.save(out)
