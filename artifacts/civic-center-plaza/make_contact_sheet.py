"""Compose the review renders into civic-center-plaza-contact-sheet.png."""
...
BG = (237, 227, 209)
INK = (58, 52, 44)
VIEWS = ["top", "aerial", "axis", "north", "east", "south", "west", "aerial-night"]
COLS = 4
PAD = 40
LABEL_H = 56
CELL_W = 520
...
def load(view):
    img = Image.open(HERE / f"civic-center-plaza-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "civic-center-plaza-contact-sheet.png"
    sheet.save(out)
