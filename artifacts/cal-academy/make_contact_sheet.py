"""Compose the six review renders into cal-academy-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"cal-academy-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "cal-academy-contact-sheet.png"
    sheet.save(out)
