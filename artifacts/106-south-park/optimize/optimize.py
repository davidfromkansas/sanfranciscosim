...
# coplanar RING BANDS. This one has the worst case of them — `parapet` is a
# closed annulus following the whole 7.32 x 29.72 m footprint, and the cornice,
# dentil course and sign band are all long coplanar strips. Re-triangulating an
