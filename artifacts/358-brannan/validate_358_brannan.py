"""Fresh-scene contract validation for 358-brannan.glb.
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3936350, 37.7809258],
    ...
    results["checks"] = {
        "meters_and_plausible_dimensions": 9.4 <= dims.z <= 9.8
        and 21.5 <= dims.x <= 24.5
        and 21.5 <= dims.y <= 24.5,
        "crest_normalized_to_target": abs(mx.z - 9.6) <= 0.02,
