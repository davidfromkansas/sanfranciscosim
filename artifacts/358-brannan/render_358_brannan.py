"""Controlled review renders of the exported 358 Brannan Street GLB.
...
(north = Blender +Y), which is how the asset is authored — the Brannan Street front faces SE (135.3 deg).
...
def main():
    ...
    glb = arg("--glb", os.path.join(here, "358-brannan.glb"))
    out = arg("--out", here)
    prefix = arg("--prefix", "358-brannan")
    night = "--night" in argv
    ...
    # --- top view: the two roof levels, parapet ring, skylights and deck rail ----
    ...
    aer.data.type = "PERSP"
    # 105 mm cropped this asset: it is 25 m long on the diagonal inside a 23 m
