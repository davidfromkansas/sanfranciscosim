"""Compose the review renders into 358-brannan-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"358-brannan-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "358-brannan-contact-sheet.png"
    sheet.save(out)
