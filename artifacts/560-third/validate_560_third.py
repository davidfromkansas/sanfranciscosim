"""Fresh-scene contract validation for 560-third.glb.

    blender -b --python validate_560_third.py -- [--glb FILE] [--out FILE]
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3951188, 37.7804142],
        "front_heading_deg_true": 44.1,
        "target_height_m": 7.2,
    ...
    results["checks"] = {
        "meters_and_plausible_dimensions": 7.0 <= dims.z <= 7.4
        and 23.0 <= dims.x <= 25.0
        and 23.0 <= dims.y <= 25.0,
        "crest_normalized_to_target": abs(mx.z - 7.2) <= 0.02,
