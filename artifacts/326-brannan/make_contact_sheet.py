"""Compose the review renders into 326-brannan-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"326-brannan-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "326-brannan-contact-sheet.png"
    sheet.save(out)
