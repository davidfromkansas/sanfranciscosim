"""Compose the 590 Third Street review contact sheet from the rendered tiles.

    python3 make_contact_sheet.py [--dir DIR] [--prefix 590-third]
...
The aerial from due east gets the hero slot: it is the only frame in which
both designed street elevations, the east corner and the raised parapet over it
read at once.
"""
...
INK = (58, 53, 48)
TILES = [
    ("aerial", "AERIAL 3/4 — from due east, 40° down (hero)"),
    ("top", "TOP — brown roof, light well, stair head"),
    ("night", "NIGHT — the shopfront ribbon wraps the corner"),
...
def main():
    ...
    ap.add_argument("--prefix", default="590-third")
    args = ap.parse_args()
