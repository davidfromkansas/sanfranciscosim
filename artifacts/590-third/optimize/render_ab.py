...
RES = (960, 720)
FOV_DEG = 40.0
AZIMUTH = math.radians(0.0)    # due east: the bisector of the 3rd Street
                               # front (45.2 deg) and the Brannan front (135.1 deg),
                               # so both designed faces and the raised corner read
