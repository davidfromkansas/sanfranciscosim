"""Fresh-scene contract validation for bill-graham-civic-auditorium.glb.
...
def main():
    ...
    results = {
        ...
        "heading_deg_cw_from_north": 80.69,
    ...
    results["checks"] = {
        "meters_and_plausible_dimensions": (
            137.0 <= dims.x <= 145.0 and 96.0 <= dims.y <= 104.0 and 36.7 <= dims.z <= 37.3
        ),  # world-aligned bbox of a 127.95 x 78.64 m footprint at 80.69 deg
