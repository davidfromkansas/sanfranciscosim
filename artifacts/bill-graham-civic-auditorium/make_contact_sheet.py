"""Compose the review renders into bill-graham-civic-auditorium-contact-sheet.png."""
...
FONT = _font()
VIEWS = ["north", "east", "south", "west", "top", "aerial", "night", "night-front"]
LABELS = {
    "north": "NORTH (Grove St arcade front)",
    "east": "EAST (Polk St pavilion)",
    "south": "SOUTH (rear)",
    "west": "WEST (Larkin St pavilion)",
    "top": "TOP (the octagonal dome)",
    "aerial": "AERIAL (app camera)",
    "night": "NIGHT (glow set)",
    "night-front": "NIGHT (arcade + marquee)",
}
COLS = 2
PAD = 40
LABEL_H = 56
...
def load(view):
    img = Image.open(HERE / f"bill-graham-civic-auditorium-{view}.png").convert("RGB")
...
def main():
    ...
    out = HERE / "bill-graham-civic-auditorium-contact-sheet.png"
    sheet.save(out)
