"""Fresh-scene contract validation for 101-south-park.glb.
...
TRI_BUDGET = 9000
TARGET_HEIGHT = 10.9   # penthouse crest; the parapet crest is 10.0 m
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3937582, 37.7812624],
        "front_heading_deg_true": 318.3,
        "target_height_m": TARGET_HEIGHT,
        "parapet_crest_m": 10.0,
    ...
    results["checks"] = {
        "meters_and_plausible_dimensions": 10.7 <= dims.z <= 11.1
        and 29.0 <= dims.x <= 32.0
        and 29.0 <= dims.y <= 32.0,
