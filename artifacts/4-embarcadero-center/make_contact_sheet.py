"""Compose the review renders into 4-embarcadero-center-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"4-embarcadero-center-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "4-embarcadero-center-contact-sheet.png"
    sheet.save(out)
