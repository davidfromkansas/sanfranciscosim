...
RES = (1500, 1000)   # landscape: a 43 m slab under a 16.5 m ridge
AER_RES = (1400, 1200)
TOP_RES = (1200, 1200)
...
def render_top(center, mx, width, span, out, prefix):
    """Top view: the full 43 m ridge, its glazing and the mechanical roof."""
...
def main():
    ...
    out = arg("--out", here)
    prefix = arg("--prefix", "181-south-park")
    night = "--night" in argv
    only = arg("--only", None)
