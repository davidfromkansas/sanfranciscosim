"""Compose the review renders into 181-south-park-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"181-south-park-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "181-south-park-contact-sheet.png"
    sheet.save(out)
