"""Fresh-scene contract validation for 58-south-park.glb.

    blender -b --python validate_58_south_park.py -- [--glb FILE] [--out FILE]
...
TRI_BUDGET = 10000
TARGET_HEIGHT = 16.9   # roof-office crest; the main parapet crest is 13.6 m
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3938881, 37.7821223],
        "front_heading_deg_true": 135.2,
        "target_height_m": TARGET_HEIGHT,
        "parapet_crest_m": 13.6,
    ...
    results["checks"] = {
        # The XY bbox is ~28 x 28 m for a 9.73 x 30.10 m building because the
        # SoMa grid runs at 45 deg — expected, not a scale error.
        "meters_and_plausible_dimensions": 16.7 <= dims.z <= 17.1
        and 27.5 <= dims.x <= 29.5
        and 27.5 <= dims.y <= 29.5,
