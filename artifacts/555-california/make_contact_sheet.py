"""Compose the six review renders into 555-california-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"555-california-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "555-california-contact-sheet.png"
    sheet.save(out)
