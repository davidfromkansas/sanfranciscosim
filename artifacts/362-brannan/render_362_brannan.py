"""Controlled review renders of the exported 362 Brannan Street GLB.

    blender -b --python render_362_brannan.py -- [--glb FILE] [--out DIR]
                                                    [--prefix 362-brannan]
                                                    [--night]
...
(north = Blender +Y), which is how the asset is authored — the Brannan Street front faces SE (135.9 deg).
...
def main():
    ...
    glb = arg("--glb", os.path.join(here, "362-brannan.glb"))
    out = arg("--out", here)
    prefix = arg("--prefix", "362-brannan")
    night = "--night" in argv
    ...
    # --- top view: parapet ring, the sloped bay roof, skylights and the mechanical pair ----------
