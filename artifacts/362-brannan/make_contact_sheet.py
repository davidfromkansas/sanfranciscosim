"""Compose the review renders into 362-brannan-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"362-brannan-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "362-brannan-contact-sheet.png"
    sheet.save(out)
