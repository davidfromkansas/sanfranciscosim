...
#   4. (skipped) curve retess — 362 Brannan has no curved geometry at all: every
#      solid is a box, a wall panel or a flat sloped plane, so there is nothing to
#      retessellate (inspect.json over_tess found no candidates)
