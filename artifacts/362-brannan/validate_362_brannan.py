"""Fresh-scene contract validation for 362-brannan.glb.

    blender -b --python validate_362_brannan.py -- [--glb FILE] [--out FILE]
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3937450, 37.7808430],
        "front_heading_deg_true": 135.9,
        "target_height_m": 8.6,
