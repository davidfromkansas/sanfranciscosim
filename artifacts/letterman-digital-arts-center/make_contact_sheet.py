"""Compose the six review renders into letterman-digital-arts-center-contact-sheet.png."""
...
PREFIX = "letterman-digital-arts-center"
BG = (237, 227, 209)
INK = (58, 52, 44)
VIEWS = ["north", "east", "south", "west", "top", "aerial"]
LABELS = {
    "west": "WEST",
    "north": "NORTH — O'REILLY AVE",
    "south": "SOUTH — LETTERMAN DR",
    "east": "EAST — LAGOON SIDE",
    "top": "TOP",
    "aerial": "AERIAL 3/4",
}
COLS = 3
