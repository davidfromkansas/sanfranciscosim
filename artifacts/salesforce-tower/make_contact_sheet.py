"""Compose the six review renders into salesforce-tower-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"salesforce-tower-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "salesforce-tower-contact-sheet.png"
    sheet.save(out)
