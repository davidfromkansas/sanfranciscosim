"""Compose the review renders into war-memorial-opera-house-contact-sheet.png."""
...
LABELS = {
    "north": "NORTH (memorial court flank)",
    "east": "EAST (Van Ness colonnade)",
    "south": "SOUTH (Grove St flank)",
...
def load(view):
    img = Image.open(HERE / f"war-memorial-opera-house-{view}.png").convert("RGB")
...
def main():
    ...
    out = HERE / "war-memorial-opera-house-contact-sheet.png"
    sheet.save(out)
