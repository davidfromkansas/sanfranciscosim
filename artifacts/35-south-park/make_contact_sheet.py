"""Compose the review renders into 35-south-park-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"35-south-park-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "35-south-park-contact-sheet.png"
    sheet.save(out)
