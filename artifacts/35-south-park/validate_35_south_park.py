"""Fresh-scene contract validation for 35-south-park.glb.
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3933378, 37.7815714],
        "front_heading_deg_true": 315.9,
        "target_height_m": 13.4,
    ...
    results["checks"] = {
        "meters_and_plausible_dimensions": 13.2 <= dims.z <= 13.6
        and 41.0 <= dims.x <= 43.0
        and 39.0 <= dims.y <= 41.5,
        "crest_normalized_to_target": abs(mx.z - 13.4) <= 0.02,
