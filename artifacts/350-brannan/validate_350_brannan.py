"""Fresh-scene contract validation for 350-brannan.glb.
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3935234, 37.7810229],
        "front_heading_deg_true": 135.8,
        "target_height_m": 13.85,
    ...
    results["checks"] = {
        "meters_and_plausible_dimensions": 13.6 <= dims.z <= 14.1
        and 31.0 <= dims.x <= 35.0
        and 31.0 <= dims.y <= 35.0,
        "crest_normalized_to_target": abs(mx.z - 13.85) <= 0.02,
