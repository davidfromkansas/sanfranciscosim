"""Compose the review renders into 350-brannan-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"350-brannan-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "350-brannan-contact-sheet.png"
    sheet.save(out)
