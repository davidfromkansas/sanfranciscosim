...
#
# The generic script runs a 0.05 deg limited dissolve here. On 350 Brannan it
# is a net loss and it was reverted under GLB-OPTIMIZE-PROMPT s.11 ("phases are
# independent; revert any phase that regresses").
#
