"""Compose the review renders into 49-south-park-contact-sheet.png."""
...
VIEWS = ["facade", "north", "west", "aerial", "top", "aerial-night",
         "east", "south"]
COLS = 3
PAD = 40
LABEL_H = 56
...
def load(view):
    img = Image.open(HERE / f"49-south-park-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "49-south-park-contact-sheet.png"
    sheet.save(out)
