"""Fresh-scene contract validation for 49-south-park.glb.
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3935926, 37.7814648],
        "front_heading_deg_true": 315.8,
        "flank_heading_deg_true": 225.8,
        "long_axis_heading_deg_true": 135.8,
    ...
    results["checks"] = {
        # ~23.6 x 22.6 x 13.0 m: the XY box is the 45.8 deg rotation of a
        # 12.90 x 17.70 m building plus its bays, not a 23 m building. See
        # REPORT.md.
        "meters_and_plausible_dimensions": (
            12.9 <= dims.z <= 13.1
            and 22.5 <= dims.x <= 24.5
            and 21.5 <= dims.y <= 23.5
        ),
        "crest_normalized_to_target": abs(mx.z - 13.0) <= 0.02,
