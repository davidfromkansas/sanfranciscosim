...
RES = (960, 720)
FOV_DEG = 40.0
AZIMUTH = math.radians(270.8)  # matched to this asset's review aerial:
                               # straight over the West corner, on the
                               # bisector of the two hero elevations, so the
                               # park front, the alley flank and the rounded
                               # corner turret are all in frame
