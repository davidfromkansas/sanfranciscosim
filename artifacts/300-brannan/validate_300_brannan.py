"""Fresh-scene contract validation for 300-brannan.glb.

    blender -b --python validate_300_brannan.py -- [--glb FILE] [--out FILE]
...
# The manifest target height: the rooftop penthouse cap, which must be the
# export bounding-box top so the loader's targetHeightM / measuredHeight is 1.0.
TARGET_HEIGHT_M = 25.2
