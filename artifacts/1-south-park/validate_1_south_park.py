"""Fresh-scene contract validation for 1-south-park.glb.

    blender -b --python validate_1_south_park.py -- [--glb FILE] [--out FILE]
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3928634, 37.7820480],
        "south_park_heading_deg_true": 315.04,
        "second_street_heading_deg_true": 45.28,
        "second_street_north_heading_deg_true": 44.60,
        "step_return_heading_deg_true": 315.10,
        "party_sw_heading_deg_true": 224.61,
        "party_se_heading_deg_true": 135.42,
        "target_height_m": 20.2,
    ...
    results["checks"] = {
        # ~58.9 x 54.9 x 20.2 m: the XY box is the ~45 deg rotation of a
        # six-sided block whose longest side is 43.2 m, not a 59 m building.
        # See REPORT.md.
        "meters_and_plausible_dimensions": (
            20.0 <= dims.z <= 20.4
            and 57.0 <= dims.x <= 61.0
            and 53.0 <= dims.y <= 57.0
        ),
        "crest_normalized_to_target": abs(mx.z - 20.2) <= 0.02,
