...
#   4. (skipped) curve retess — the only curves are the 5-segment arch heads and
#      the 10-segment medallion discs, both already at the floor
...
# large coplanar ring bands." 1 South Park carries three full-footprint ring
# bands built with ring() — the two cornice steps, the parapet, and one coping
# per penthouse piece. Their top and bottom faces
...
stats["limited_dissolve"] = "skipped: coplanar ring bands (see comment)"
