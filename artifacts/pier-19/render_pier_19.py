"""Controlled review renders of the exported Pier 1 GLB.
    ...
    blender -b --python render_pier_19.py -- [--glb FILE] [--out DIR]
                                            [--prefix pier-19] [--night]
...
keeps its nearest compass filename:
    ...
    -north.png  the north-west shed flank, faces 323.8 deg (the Pier 23 slip)
    -south.png  the south-east shed flank, faces 143.8 deg (the Pier 17 slip)
...
AXIS = 54.89               # long axis, to the north-east
...
def main():
    ...
    span = 268.0          # the pier's own length, not the 45-degree bbox
    if night:
        light_glow()
