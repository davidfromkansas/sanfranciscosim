...
#
# Adapted for 226-ritch: skips limited dissolve (§3 step 3) because the asset
# has three ring bands (parapet, base_cap, deck_rail) whose coplanar annuli
# would merge into sliver ngons on re-triangulation.
#
...
#   3. SKIP limited dissolve — ring bands present (parapet, base_cap, deck_rail)
...
stats["dissolve_skipped"] = "ring bands present (parapet, base_cap, deck_rail)"
