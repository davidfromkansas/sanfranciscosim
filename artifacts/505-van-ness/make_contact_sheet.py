"""Compose the review renders into 505-van-ness-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"505-van-ness-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "505-van-ness-contact-sheet.png"
    sheet.save(out)
