"""Compose the review renders into 27-south-park-contact-sheet.png."""
...
BG = (237, 227, 209)
INK = (58, 52, 44)
VIEWS = ["front", "north", "east", "south", "west", "top", "aerial", "aerial-night"]
COLS = 4
PAD = 40
LABEL_H = 56
CELL_W = 460
...
def load(view):
    img = Image.open(HERE / f"27-south-park-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "27-south-park-contact-sheet.png"
    sheet.save(out)
