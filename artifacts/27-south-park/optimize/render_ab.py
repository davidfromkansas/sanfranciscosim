...
RES = (960, 720)
FOV_DEG = 40.0
AZIMUTH = math.radians(315.0)  # fixed 3/4 view from the NORTH-WEST: the one
                               # public elevation faces 314.8 deg, and a diff
                               # taken against a blind party wall proves nothing
