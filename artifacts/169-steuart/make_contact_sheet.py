"""Compose the review renders into 169-steuart-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"169-steuart-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "169-steuart-contact-sheet.png"
    sheet.save(out)
