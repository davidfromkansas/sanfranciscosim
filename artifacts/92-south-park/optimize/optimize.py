...
# ASSET ADAPTATION (92-south-park): every parapet, the mosaic stripe, the roof
# rail and the balcony rail are
# closed ring bands following the footprint all the way round, i.e. exactly the
# case GLB-OPTIMIZE-PROMPT s.3 step 3 warns about — their top and bottom faces
# are coplanar annuli, a strictly-coplanar dissolve merges each into one ngon,
# and re-triangulating an annulus emits sub-millimetre slivers that only the
# stage-2 contract validator sees, two steps later and after the shipping swap.
# They are skipped by name; everything else still dissolves.
RING_BANDS = {
    "A1_parapet", "A2_parapet", "B_parapet", "C_parapet",
    "stripe_front", "stripe_rear", "roof_rail", "balcony_rail",
}
