...
RES = (960, 720)
FOV_DEG = 40.0
AZIMUTH = math.radians(156.0)  # matches the review rig: the shopfront, the
                               # gold band and the depth in one frame. The
                               # generic 45 deg looks straight down the blind
                               # north-east party flank, where nothing is at
                               # risk and nothing would be caught.
