"""Compose the review renders into 380-brannan-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"380-brannan-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "380-brannan-contact-sheet.png"
    sheet.save(out)
