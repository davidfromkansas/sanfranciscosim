"""Controlled review renders of the exported 380 Brannan Street GLB.
...
(north = Blender +Y), which is how the asset is authored — the Brannan Street front faces SE (135.6 deg).
...
def main():
    ...
    glb = arg("--glb", os.path.join(here, "380-brannan.glb"))
    out = arg("--out", here)
    prefix = arg("--prefix", "380-brannan")
    night = "--night" in argv
