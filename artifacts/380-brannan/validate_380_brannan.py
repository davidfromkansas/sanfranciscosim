"""Fresh-scene contract validation for 380-brannan.glb.
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3940217, 37.7806308],
        "front_heading_deg_true": 135.6,
    ...
    results["checks"] = {
        ...
        and 29.0 <= dims.x <= 33.0
        and 29.0 <= dims.y <= 33.0,
