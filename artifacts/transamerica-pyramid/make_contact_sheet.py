"""Compose the six review renders into transamerica-pyramid-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"transamerica-pyramid-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "transamerica-pyramid-contact-sheet.png"
    sheet.save(out)
