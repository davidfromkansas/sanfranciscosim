"""Compose the 131 Steuart Street review contact sheet from the rendered tiles.

    python3 make_contact_sheet.py [--dir DIR] [--prefix 131-steuart]
...
INK = (58, 53, 48)
TILES = [
    ("top", "TOP — roof: monitor spine, plant, penthouse barrel at the NE end"),
    ("aerial", "AERIAL 3/4 — from the bay (NE), 40 deg down"),
    ("night", "NIGHT — penthouse lantern hero, two lit office bands, restaurant"),
    ("south", "STEUART ST elevation (SW, 224.9) — 1907 brick, 5 bays, 7 storeys"),
    ("north", "THE EMBARCADERO elevation (NE, 44.8) — 1983 cast stone + penthouse"),
    ("east", "SE party wall with 141 Steuart (135.0) — blind"),
    ("west", "NW party wall with 121 Steuart (314.6) — blind"),
]
...
def main():
    ...
    ap.add_argument("--prefix", default="131-steuart")
    args = ap.parse_args()
