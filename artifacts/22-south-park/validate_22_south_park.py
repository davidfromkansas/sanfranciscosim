"""Fresh-scene contract validation for 22-south-park.glb.

    blender -b --python validate_22_south_park.py -- [--glb FILE] [--out FILE]
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3936099, 37.7823247],
        "front_heading_deg_true": 159.5,
        "long_axis_heading_deg_true": 315.18,
        "target_height_m": 14.22,
    ...
    results["checks"] = {
        # ~36.0 x 31.8 x 14.22 m: the XY box is the axis-aligned bound of a
        # TRAPEZOID standing at 45 deg (party walls 36.28 and 30.13 m, rear
        # 13.68 m, frontage a 15.14 m arc), not a 40 m building. See REPORT.md.
        "meters_and_plausible_dimensions": (
            14.15 <= dims.z <= 14.30
            and 35.6 <= dims.x <= 36.4
            and 31.4 <= dims.y <= 32.3
        ),
        "crest_normalized_to_target": abs(mx.z - 14.22) <= 0.02,
