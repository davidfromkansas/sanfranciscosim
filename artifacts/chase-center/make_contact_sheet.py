"""Compose the review renders into chase-center-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"chase-center-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "chase-center-contact-sheet.png"
    sheet.save(out)
