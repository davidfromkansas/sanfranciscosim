"""Controlled review renders of the exported Chase Center GLB.
...
Chase Center is a wide, low building, so the rig is framed on the plan extent
...
def main():
    ...
    glb = arg("--glb", os.path.join(here, "chase-center.glb"))
    out = arg("--out", here)
    prefix = arg("--prefix", "chase-center")
    only = arg("--only", "")
    ...
    az_n = math.radians(272)  # standing on the Thrive City plaza
    rn = span * 2.05
