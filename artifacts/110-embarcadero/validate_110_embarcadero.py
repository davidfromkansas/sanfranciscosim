"""Fresh-scene contract validation for 110-embarcadero.glb.

    blender -b --python validate_110_embarcadero.py -- [--glb FILE] [--out FILE]
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3926614, 37.7932332],
        "front_heading_deg_true": 44.83,
        "flank_heading_deg_true": 224.94,
        "long_axis_heading_deg_true": 135.24,
        "target_height_m": 17.4,
    ...
    results["checks"] = {
        # ~40.5 x 40.2 x 17.4 m: the XY box is the 135.24 deg rotation of a
        # 41.87 x 13.91 m through-lot building, not a 40 m building. See
        # REPORT.md.
        ...
        "crest_normalized_to_target": abs(mx.z - 17.4) <= 0.02,
