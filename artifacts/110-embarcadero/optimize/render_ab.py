...
RES = (960, 720)
FOV_DEG = 40.0
AZIMUTH = math.radians(44.83)  # matched to this asset's review aerial: from
                               # the north-east, over The Embarcadero, looking
                               # back down the long axis so the glass front, the
                               # roof terrace and the step down to the Steuart
                               # pediment are all in one frame
