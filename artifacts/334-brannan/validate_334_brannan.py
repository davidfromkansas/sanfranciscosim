"""Fresh-scene contract validation for 334-brannan.glb.

    blender -b --python validate_334_brannan.py -- [--glb FILE] [--out FILE]
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3930344, 37.7814147],
    ...
    results["checks"] = {
        ...
        and 28.5 <= dims.x <= 32.0
        and 28.5 <= dims.y <= 32.0,
