"""Compose the review renders into 334-brannan-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"334-brannan-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "334-brannan-contact-sheet.png"
    sheet.save(out)
