"""Compose the review renders into sf-main-library-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"sf-main-library-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "sf-main-library-contact-sheet.png"
    sheet.save(out)
