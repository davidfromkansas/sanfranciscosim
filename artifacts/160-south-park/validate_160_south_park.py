"""Fresh-scene contract validation for 160-south-park.glb.
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3948620, 37.7812804],
        "registry_exclusion_lonlat": [-122.3949116, 37.7812949],
        "front_heading_deg_true": 108.13,
        "long_axis_heading_deg_true": 299.3,
        "target_height_m": 9.4,
    ...
    results["checks"] = {
        # 25.8 x 17.8 x 9.4 m: the XY box is the ~108 deg rotation of a
        # 6.2 x 26.5 m strip, not a 26 m building. See REPORT.md.
        "meters_and_plausible_dimensions": (
            9.3 <= dims.z <= 9.5
            and 25.3 <= dims.x <= 26.3
            and 17.3 <= dims.y <= 18.3
        ),
        "crest_normalized_to_target": abs(mx.z - 9.4) <= 0.02,
