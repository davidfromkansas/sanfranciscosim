"""Compose the review renders into 340-brannan-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"340-brannan-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "340-brannan-contact-sheet.png"
    sheet.save(out)
