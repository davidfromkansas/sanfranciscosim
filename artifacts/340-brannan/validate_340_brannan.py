"""Fresh-scene contract validation for 340-brannan.glb.

    blender -b --python validate_340_brannan.py -- [--glb FILE] [--out FILE]
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3932324, 37.7812786],
        "front_heading_deg_true": 135.4,
        "target_height_m": 17.79,
    ...
    results["checks"] = {
        "meters_and_plausible_dimensions": 17.5 <= dims.z <= 18.1
        and 39.0 <= dims.x <= 43.0
        and 39.0 <= dims.y <= 43.0,
        "crest_normalized_to_target": abs(mx.z - 17.79) <= 0.02,
