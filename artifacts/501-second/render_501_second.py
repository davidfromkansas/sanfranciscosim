...
(north = Blender +Y), which is how the asset is authored — the Second Street front faces SW (225.4 deg).
...
def main():
    ...
    glb = arg("--glb", os.path.join(here, "501-second.glb"))
    out = arg("--out", here)
    prefix = arg("--prefix", "501-second")
    night = "--night" in argv
    ...
    if night:
        ...
        az = math.radians(270.0)  # from due west: sees BOTH street elevations
    ...
    az = math.radians(270.0)  # from due west — the bisector of the Second Street
