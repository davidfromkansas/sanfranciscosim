"""Compose the review renders into 501-second-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"501-second-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "501-second-contact-sheet.png"
    sheet.save(out)
