"""Fresh-scene contract validation for 501-second.glb.

    blender -b --python validate_501_second.py -- [--glb FILE] [--out FILE]
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3929683, 37.7831785],
        "front_heading_deg_true": 225.4,
        "target_height_m": 37.7,
    ...
    results["checks"] = {
        ...
        # axis-aligned bounding box. That is expected, not a scale error.
        "meters_and_plausible_dimensions": 37.5 <= dims.z <= 37.9
        and 81.0 <= dims.x <= 85.0
        and 81.0 <= dims.y <= 85.0,
        "crest_normalized_to_target": abs(mx.z - 37.7) <= 0.02,
