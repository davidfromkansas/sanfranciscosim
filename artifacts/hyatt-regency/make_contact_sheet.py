"""Compose the review renders into hyatt-regency-contact-sheet.png."""
...
FONT = _font()
VIEWS = ["north", "east", "south", "west", "top", "aerial", "night", "night-entry"]
COLS = 4
PAD = 40
LABEL_H = 56
CELL_W = 460
...
def load(view):
    img = Image.open(HERE / f"hyatt-regency-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "hyatt-regency-contact-sheet.png"
    sheet.save(out)
