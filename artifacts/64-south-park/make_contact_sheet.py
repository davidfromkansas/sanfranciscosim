"""Compose the review renders into 64-south-park-contact-sheet.png."""
...
BG = (237, 227, 209)
INK = (58, 52, 44)
VIEWS = ["top", "aerial", "axis", "aerial-night", "nw-side", "se-side", "sw-end", "ne-end"]
COLS = 4
PAD = 40
LABEL_H = 56
CELL_W = 520
...
def load(view):
    img = Image.open(HERE / f"64-south-park-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "64-south-park-contact-sheet.png"
    sheet.save(out)
