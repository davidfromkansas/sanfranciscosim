"""Fresh-scene contract validation for 1008-general-kennedy.glb.

    blender -b --python validate_1008_general_kennedy.py -- [--glb FILE] [--out FILE]
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.4514809, 37.8007878],
        "front_heading_deg_true": 116.85,
        "target_height_m": 11.9,
    ...
    results["checks"] = {
        # 55.1 x 35.5 x 11.9 m: the XY box is the ~27 deg rotation of a
        # 55.14 x 12.02 m ward, not a fat building. See REPORT.md.
        "meters_and_plausible_dimensions": (
            11.7 <= dims.z <= 12.1
            and 54.5 <= dims.x <= 55.8
            and 34.9 <= dims.y <= 36.1
        ),
        "crest_normalized_to_target": abs(mx.z - 11.9) <= 0.02,
