"""Compose the review renders into 1008-general-kennedy-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"1008-general-kennedy-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "1008-general-kennedy-contact-sheet.png"
    sheet.save(out)
