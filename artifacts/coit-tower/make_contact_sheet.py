"""Compose the six review renders into coit-tower-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"coit-tower-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "coit-tower-contact-sheet.png"
    sheet.save(out)
