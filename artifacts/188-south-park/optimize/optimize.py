...
#
# Adapted for 188-south-park: skips limited dissolve (§3 step 3) because the
# asset has ring bands (parapet, floor_band, pent_railing) whose coplanar
# annuli would merge into sliver ngons on re-triangulation.
#
...
#   3. SKIP limited dissolve — ring bands present (parapet, floor_band, pent_railing)
...
# This asset has ring bands (parapet, floor_band, pent_railing) whose top and
...
stats["dissolve_skipped"] = "ring bands present (parapet, floor_band, pent_railing)"
