"""Compose the review renders into 188-south-park-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"188-south-park-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "188-south-park-contact-sheet.png"
    sheet.save(out)
