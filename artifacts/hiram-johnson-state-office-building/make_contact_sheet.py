"""Compose the review renders into hiram-johnson-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"hiram-johnson-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "hiram-johnson-contact-sheet.png"
    sheet.save(out)
