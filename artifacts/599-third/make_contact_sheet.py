"""Compose the 599 Third Street review contact sheet from the rendered tiles.

    python3 make_contact_sheet.py [--dir DIR] [--prefix 599-third]
...
The aerial from due south gets the hero slot: it is the only frame in which
both designed street elevations and the corner between them read at once.
"""
...
INK = (58, 53, 48)
TILES = [
    ("aerial", "AERIAL 3/4 — from due south, 40° down (hero)"),
    ("top", "TOP — the working roof"),
    ("night", "NIGHT — lit-loft scatter + skylights"),
...
def main():
    ...
    ap.add_argument("--prefix", default="599-third")
    args = ap.parse_args()
