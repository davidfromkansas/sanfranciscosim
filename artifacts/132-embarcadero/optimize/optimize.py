...
#   4. (n/a) curve retess — 132 The Embarcadero has no curved geometry at all: every
...
# follows the footprint all the way round." 132 The Embarcadero has TWO such rings
# stacked (parapet 8.96-9.20 m and coping 9.20-9.32 m, both following the full
# 101 m footprint perimeter). Their top and bottom faces are perfectly coplanar
