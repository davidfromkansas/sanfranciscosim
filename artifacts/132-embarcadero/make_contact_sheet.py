"""Compose the review renders into 132-embarcadero-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"132-embarcadero-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "132-embarcadero-contact-sheet.png"
    sheet.save(out)
