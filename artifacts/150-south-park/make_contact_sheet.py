"""Compose the review renders into 150-south-park-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"150-south-park-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "150-south-park-contact-sheet.png"
    sheet.save(out)
