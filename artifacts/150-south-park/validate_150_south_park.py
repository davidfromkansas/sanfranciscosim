"""Fresh-scene contract validation for 150-south-park.glb.

    blender -b --python validate_150_south_park.py -- [--glb FILE] [--out FILE]
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3947673, 37.7813810],
        "front_heading_deg_true": 133.1,
        "target_height_m": 8.0,
    ...
    results["checks"] = {
        "meters_and_plausible_dimensions": 7.9 <= dims.z <= 8.1
        and 19.0 <= dims.x <= 22.0
        and 16.5 <= dims.y <= 19.0,
        "crest_normalized_to_target": abs(mx.z - 8.0) <= 0.02,
