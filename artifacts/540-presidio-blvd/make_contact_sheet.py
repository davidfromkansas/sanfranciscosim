"""Compose the review renders into 540-presidio-blvd-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"540-presidio-blvd-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "540-presidio-blvd-contact-sheet.png"
    sheet.save(out)
