"""Compose the review renders into grace-cathedral-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"grace-cathedral-{view}.png").convert("RGB")
...
def main():
    ...
    out = HERE / "grace-cathedral-contact-sheet.png"
    sheet.save(out)
