"""Compose the review renders into pier-15-contact-sheet.png."""
...
BG = (237, 227, 209)
INK = (58, 52, 44)
VIEWS = ["north", "east", "south", "west", "frontage", "top", "water", "aerial", "aerial-night"]
COLS = 3
PAD = 40
LABEL_H = 56
CELL_W = 460
...
def load(view):
    img = Image.open(HERE / f"pier-15-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "pier-15-contact-sheet.png"
    sheet.save(out)
