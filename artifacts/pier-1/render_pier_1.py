"""Controlled review renders of the exported Pier 1 GLB.
    ...
    blender -b --python render_pier_1.py -- [--glb FILE] [--out DIR]
                                            [--prefix pier-1] [--night]
...
keeps its nearest compass filename:
    ...
    -north.png  the north-west shed flank, faces 323.8 deg (the Pier 3 slip)
    -south.png  the south-east shed flank, faces 143.8 deg (the Ferry Building)
...
AXIS = 53.77               # long axis, to the north-east
...
def main():
    ...
    span = 240.0          # the pier's own length, not the 45-degree bbox
    if night:
        light_glow()
