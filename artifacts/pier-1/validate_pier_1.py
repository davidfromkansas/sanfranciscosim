"""Fresh-scene contract validation for pier-1.glb.
...
def main():
    ...
    glb = arg("--glb", os.path.join(here, "pier-1.glb"))
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3941164, 37.7974191],
        "front_heading_deg_true": 233.77,
        "flank_heading_deg_true": 323.77,
        "long_axis_heading_deg_true": 53.77,
        "target_height_m": 15.4,
        ...
        "origin_convention": (
            ...
            "min_z_m is NEGATIVE BY DESIGN. See docs/asset-plans/pier-1.md 2.3."
        ),
    ...
    results["checks"] = {
        # ~215 x 185 x 15.4 m: the XY box is the 53.77 deg rotation of a
        # 234 x 55 m pier, not a 215 m wide object. See REPORT.md.
        "meters_and_plausible_dimensions": (
            15.3 <= dims.z <= 15.5
            and 210.0 <= dims.x <= 220.0
            and 180.0 <= dims.y <= 190.0
        ),
        "vertical_extent_normalized_to_target": abs(dims.z - 15.4) <= 0.02,
        ...
        "deck_plane_at_z_zero": abs(mx.z - 12.8) <= 0.02,
