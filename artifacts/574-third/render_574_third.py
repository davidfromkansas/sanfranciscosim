"""Controlled review renders of the exported 574 Third Street GLB.
...
(north = Blender +Y), which is how the asset is authored — the Third Street front faces NE (44.8 deg).
...
RES = (1500, 1000)   # landscape: this building is wide
AER_RES = (1400, 1200)
TOP_RES = (1200, 1200)
...
def main():
    ...
    glb = arg("--glb", os.path.join(here, "574-third.glb"))
    out = arg("--out", here)
    prefix = arg("--prefix", "574-third")
    night = "--night" in argv
