"""Fresh-scene contract validation for 574-third.glb.
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3950551, 37.7801937],
        "front_heading_deg_true": 44.8,
    ...
    results["checks"] = {
        "meters_and_plausible_dimensions": 15.2 <= dims.z <= 15.6
        and 62.0 <= dims.x <= 68.0
        and 57.0 <= dims.y <= 63.0,
        "crest_normalized_to_target": abs(mx.z - 15.4) <= 0.02,
