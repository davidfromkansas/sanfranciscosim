"""Compose the review renders into 234-van-ness-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"234-van-ness-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "234-van-ness-contact-sheet.png"
    sheet.save(out)
