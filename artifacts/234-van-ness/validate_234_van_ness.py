"""Fresh-scene contract validation for 234-van-ness.glb (The Kelsey Civic Center).

    blender -b --python validate_234_van_ness.py -- [--glb FILE] [--out FILE]
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.4193071, 37.7780541],
        "front_heading_deg_true": 261.8,
        "target_height_m": 30.12,
    ...
    results["checks"] = {
        "meters_and_plausible_dimensions": 29.9 <= dims.z <= 30.3
        and 54.0 <= dims.x <= 58.0
        and 44.0 <= dims.y <= 48.0,
        "crest_normalized_to_target": abs(mx.z - 30.12) <= 0.02,
