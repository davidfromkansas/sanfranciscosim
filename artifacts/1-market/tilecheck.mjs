...
// standing under the 1 Market asset — and report penetration DEPTH, because a
...
const LON = -122.3948075, LAT = 37.7938412;
const [ax, az] = project(LON, LAT);

// the asset's own wall ring, model-space, from build_1_market.py FOOTPRINT
const FOOT = [
  [-6.953,-53.483],[3.257,-43.356],[-22.025,-17.868],[17.371,21.210],
  [42.653,-4.278],[53.537,6.518],[6.952,53.482],[-53.538,-6.519],
