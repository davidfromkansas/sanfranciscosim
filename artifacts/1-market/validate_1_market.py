"""Fresh-scene contract validation for 1-market.glb.

    blender -b --python validate_1_market.py -- [--glb FILE] [--out FILE]
...
Normals are checked two ways, because this asset is a union of ~730 closed
...
# The manifest target height: the rooftop plant fan-bank cap, which must be the
# export bounding-box top so the loader's targetHeightM / measuredHeight is 1.0.
TARGET_HEIGHT_M = 48.7
