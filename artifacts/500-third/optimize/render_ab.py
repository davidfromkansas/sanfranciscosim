...
# This Mac has a Metal GPU and is running many parallel Blender sessions; on CPU
# a single frame was getting ~5% of one core. Both A and B render on the same
# device, so the comparison is unaffected.
