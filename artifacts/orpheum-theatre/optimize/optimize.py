...
#      -- OPTIONAL here: this asset is built almost entirely from ring_prism
#      parapets, tile eaves and caps, i.e. large coplanar annuli, which is
#      exactly the case GLB-OPTIMIZE-PROMPT §3.3 says to skip. Run the
#      four-variant table (weld x dissolve) and judge by bytes, not by theory.
#   4. (skipped) curve retess — the arcade arch heads are already at 8 segments
...
stats["variant"] = {"weld": DO_WELD, "dissolve": DO_DISSOLVE}
