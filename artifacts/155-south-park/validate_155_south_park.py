"""Fresh-scene contract validation for 155-south-park.glb.

    blender -b --python validate_155_south_park.py -- [--glb FILE] [--out FILE]
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3942202, 37.7808993],
        "front_heading_deg_true": 327.2,
        "target_height_m": 10.1,
    ...
    results["checks"] = {
        "meters_and_plausible_dimensions": 9.9 <= dims.z <= 10.3
        and 24.0 <= dims.x <= 28.0
        and 26.0 <= dims.y <= 31.0,
        "crest_normalized_to_target": abs(mx.z - 10.1) <= 0.02,
