"""Compose the review renders into 155-south-park-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"155-south-park-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "155-south-park-contact-sheet.png"
    sheet.save(out)
