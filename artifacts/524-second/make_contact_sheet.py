"""Compose the review renders into 524-second-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"524-second-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "524-second-contact-sheet.png"
    sheet.save(out)
