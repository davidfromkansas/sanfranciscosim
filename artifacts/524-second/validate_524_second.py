"""Fresh-scene contract validation for 524-second.glb.

    blender -b --python validate_524_second.py -- [--glb FILE] [--out FILE]
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3934330, 37.7825731],
    ...
    results["checks"] = {
        ...
        "meters_and_plausible_dimensions": 9.7 <= dims.z <= 10.1
        and 34.5 <= dims.x <= 37.5
        and 34.5 <= dims.y <= 37.5,
        "crest_normalized_to_target": abs(mx.z - 9.9) <= 0.02,
