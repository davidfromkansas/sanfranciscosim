"""Compose the six review renders into davies-symphony-hall-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"davies-symphony-hall-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "davies-symphony-hall-contact-sheet.png"
    sheet.save(out)
