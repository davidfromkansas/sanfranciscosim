"""Fresh-scene contract validation for 165-south-park.glb.
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3943764, 37.7808599],
        "front_heading_deg_true": 349.73,
        "long_axis_heading_deg_true": 135.3,
        "target_height_m": 9.0,
    ...
    results["checks"] = {
        # 19.0 x 21.8 x 9.0 m: the XY box is the ~145 deg rotation of a
        # 6.2 x 24.0 m sliver, not a 19 m building. See REPORT.md.
        "meters_and_plausible_dimensions": (
            8.9 <= dims.z <= 9.1
            and 18.5 <= dims.x <= 19.5
            and 21.3 <= dims.y <= 22.3
        ),
        "crest_normalized_to_target": abs(mx.z - 9.0) <= 0.02,
