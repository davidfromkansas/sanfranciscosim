"""Compose the review renders into fulton-plaza-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"fulton-plaza-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "fulton-plaza-contact-sheet.png"
    sheet.save(out)
