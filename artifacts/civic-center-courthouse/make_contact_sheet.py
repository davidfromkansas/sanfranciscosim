"""Compose the review renders into civic-center-courthouse-contact-sheet.png."""
...
FONT = _font()
VIEWS = ["north", "east", "south", "west", "top", "aerial", "night", "night-corner"]
LABELS = {
    "north": "NORTH (Golden Gate Ave)",
    "east": "EAST (Polk St)",
    "south": "SOUTH (McAllister St front)",
    "west": "WEST (mid-block flank)",
    "top": "TOP (roofscape)",
    "aerial": "AERIAL (app camera)",
    "night": "NIGHT (glow set)",
    "night-corner": "NIGHT (corner lantern)",
}
COLS = 2
PAD = 40
LABEL_H = 56
...
def load(view):
    img = Image.open(HERE / f"civic-center-courthouse-{view}.png").convert("RGB")
...
def main():
    ...
    out = HERE / "civic-center-courthouse-contact-sheet.png"
    sheet.save(out)
