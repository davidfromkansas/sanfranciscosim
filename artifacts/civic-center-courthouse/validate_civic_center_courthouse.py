"""Fresh-scene contract validation for civic-center-courthouse.glb.
...
def main():
    ...
    results = {
        ...
        "heading_deg_cw_from_north": 81.22,
    ...
    results["checks"] = {
        "meters_and_plausible_dimensions": (
            88.0 <= dims.x <= 94.0 and 48.0 <= dims.y <= 54.0 and 29.3 <= dims.z <= 29.9
        ),  # world-aligned bbox of an 83.46 x 36.98 m footprint at 81.22 deg
