"""Compose the 101 Grove Street review contact sheet from the rendered tiles.

    python3 make_contact_sheet.py [--dir DIR] [--prefix 101-grove]
...
The aerial gets the hero slot: this building is a corner bay and a cornice line,
and only the three-quarter from the north-east shows both.
"""
...
INK = (58, 53, 48)
TILES = [
    ("aerial", "AERIAL 3/4 — square onto the corner bay, 38° down"),
    ("top", "TOP — roof plan"),
    ("night", "NIGHT — the entrance lanterns, oculus and transom"),
...
def main():
    ...
    ap.add_argument("--prefix", default="101-grove")
    args = ap.parse_args()
