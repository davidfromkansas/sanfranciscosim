...
#   4. (n/a) curve retess — 168 South Park has no curved geometry: every surface
#      is a planar panel, box, prism or ring band, so there is nothing to retessellate
...
# coplanar ring bands. This one has two that follow the whole footprint —
# `parapet` (Toy_brick) and `parapet_coping` (Toy_steel) — plus a body prism
# whose cap is a 182 m2 coplanar quad. Their top and bottom faces are perfect
...
stats["steps"].append({"step": "limited-dissolve", "skipped":
                       "coplanar ring bands (parapet, parapet_coping, body cap)"})
