"""Fresh-scene contract validation for 168-south-park.glb.

    blender -b --python validate_168_south_park.py -- [--glb FILE] [--out FILE]
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3949862, 37.7811327],
        "front_heading_deg_true": 135.0,
        "target_height_m": 10.44,
    ...
    results["checks"] = {
        "meters_and_plausible_dimensions": 10.2 <= dims.z <= 10.7
        and 24.5 <= dims.x <= 26.5
        and 24.5 <= dims.y <= 26.5,
        "crest_normalized_to_target": abs(mx.z - 10.44) <= 0.02,
