"""Compose the review renders into 168-south-park-contact-sheet.png."""
...
BG = (237, 227, 209)
INK = (58, 52, 44)
VIEWS = ["north", "east", "south", "west", "front", "top", "aerial", "aerial-night"]
COLS = 3
PAD = 40
LABEL_H = 56
CELL_W = 460
...
def load(view):
    img = Image.open(HERE / f"168-south-park-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "168-south-park-contact-sheet.png"
    sheet.save(out)
