"""Fresh-scene contract validation for 41-south-park.glb.

    blender -b --python validate_41_south_park.py -- [--glb FILE] [--out FILE]
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3934793, 37.7815036],
        "front_heading_deg_true": 315.22,
        "long_axis_heading_deg_true": 135.22,
        "target_height_m": 10.6,
        "oriented_footprint_m": [7.297, 24.0],
    ...
    results["checks"] = {
        # 22.5 x 22.5 x 10.6 m: the XY box is the 135.22 deg rotation of a
        # 7.3 x 25.2 m bar, not a 22 m building. See REPORT.md.
        "meters_and_plausible_dimensions": (
            10.5 <= dims.z <= 10.7
            and 22.0 <= dims.x <= 23.0
            and 22.0 <= dims.y <= 23.0
        ),
        "crest_normalized_to_target": abs(mx.z - 10.6) <= 0.02,
