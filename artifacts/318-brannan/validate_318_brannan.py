"""Fresh-scene contract validation for 318-brannan.glb.

    blender -b --python validate_318_brannan.py -- [--glb FILE] [--out FILE]
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3927890, 37.7816014],
        "front_heading_deg_true": 135.8,
        "target_height_m": 8.6,
    ...
    results["checks"] = {
        # A 17.96 x 23.87 m rectangle at a 45.8 deg heading gives a ~29.6 m
        # axis-aligned footprint; Y runs a little longer than X because the
        # awnings project up to 1.2 m off the SE face.
        "meters_and_plausible_dimensions": 8.4 <= dims.z <= 8.8
        and 28.5 <= dims.x <= 31.5
        and 28.5 <= dims.y <= 31.5,
