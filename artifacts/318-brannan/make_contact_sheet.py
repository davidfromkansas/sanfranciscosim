"""Compose the review renders into 318-brannan-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"318-brannan-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "318-brannan-contact-sheet.png"
    sheet.save(out)
