...
# coplanar RING BANDS. This asset has TWO of them — `parapet` is a closed
# annulus round the whole 6.99 x 22.90 m main roof and `rear_parapet` is a
# second one round the 6.99 x 7.17 m rear wing — plus the long coplanar strips
# of the entrance slot and the projecting box. Re-triangulating an
...
# surface only after the shipping swap as
# `invalid_or_nonunit_loop_normal_count` in the stage-2 contract validator
# (precedent: 350-brannan, 13 Aug 2026). On this asset the step is worth a
# handful of triangles at most, so it is not worth working around.
