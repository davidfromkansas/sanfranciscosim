"""Fresh-scene contract validation for 49-zoe.glb.

    blender -b --python validate_49_zoe.py -- [--glb FILE] [--out FILE]
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3960338, 37.7800764],
    ...
    results["checks"] = {
        ...
        and 33.0 <= dims.x <= 35.5
        and 33.0 <= dims.y <= 35.5,
