"""Fresh-scene contract validation for hills-brothers-building.glb.

    blender -b --python validate_hills_brothers_building.py -- [--glb FILE] [--out FILE]
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3892854, 37.7894167],
        "front_heading_deg_true": 135.0,
        "target_height_m": 53.2,
    ...
    results["checks"] = {
        "meters_and_plausible_dimensions": 53.0 <= dims.z <= 53.4
        and 82.0 <= dims.x <= 87.0
        and 82.0 <= dims.y <= 87.0,
        "crest_normalized_to_target": abs(mx.z - 53.2) <= 0.02,
