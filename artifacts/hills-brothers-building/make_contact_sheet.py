"""Compose the review renders into hills-brothers-building-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"hills-brothers-building-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "hills-brothers-building-contact-sheet.png"
    sheet.save(out)
