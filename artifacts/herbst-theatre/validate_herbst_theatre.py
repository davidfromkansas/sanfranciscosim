"""Fresh-scene contract validation for herbst-theatre.glb.
...
def main():
    ...
    results["checks"] = {
        # World-axis AABB of the building rotated 81.11 deg: the 83.06 x 67.38 m
        # footprint plus the front steps. Z is gated tight because the loader's
        # scale must land at exactly 1.0 against targetHeightM = 31.
        "meters_and_plausible_dimensions": 88 <= dims.x <= 98 and 66 <= dims.y <= 76 and 30.9 <= dims.z <= 31.1,
