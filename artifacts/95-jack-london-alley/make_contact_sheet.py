"""Compose the review renders into 95-jack-london-alley-contact-sheet.png."""
...
BG = (237, 227, 209)
INK = (58, 52, 44)
VIEWS = ["north", "east", "south", "west", "top", "facade", "entrance", "aerial", "aerial-night"]
COLS = 3
PAD = 40
LABEL_H = 56
CELL_W = 460
...
def load(view):
    img = Image.open(HERE / f"95-jack-london-alley-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "95-jack-london-alley-contact-sheet.png"
    sheet.save(out)
