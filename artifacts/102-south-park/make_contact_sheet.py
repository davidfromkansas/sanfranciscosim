"""Compose the review renders into 102-south-park-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"102-south-park-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "102-south-park-contact-sheet.png"
    sheet.save(out)
