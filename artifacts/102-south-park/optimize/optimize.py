...
# ring bands. This one has three that follow the whole 16-vertex footprint —
# `belt` (960 tris), `parapet` (1152) and `parapet_coping` (1152), 3,264 of the
# asset's 8,100 triangles. Their top and bottom faces are perfectly coplanar
