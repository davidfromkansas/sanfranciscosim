"""Compose the review renders into earl-warren-building-contact-sheet.png."""
...
FONT = _font()
VIEWS = ["north", "east", "south", "west", "top", "aerial", "night", "night-entrance"]
COLS = 4
PAD = 40
LABEL_H = 56
CELL_W = 460
...
def load(view):
    img = Image.open(HERE / f"earl-warren-building-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "earl-warren-building-contact-sheet.png"
    sheet.save(out)
