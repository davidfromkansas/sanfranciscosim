...
RES = (960, 720)
FOV_DEG = 40.0
AZIMUTH = math.radians(343.5)  # square onto the NNW park front — this
                               # building's identity face and its ornament bands
...
scene.cycles.samples = 32  # A/B comparison only; both sides use the same setting
