"""Compose the six review renders into palace-of-fine-arts-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"palace-of-fine-arts-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "palace-of-fine-arts-contact-sheet.png"
    sheet.save(out)
