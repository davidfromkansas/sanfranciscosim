"""Compose the review renders into columbus-tower-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"columbus-tower-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "columbus-tower-contact-sheet.png"
    sheet.save(out)
