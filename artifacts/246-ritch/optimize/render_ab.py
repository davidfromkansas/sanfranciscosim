...
# 40, not 64: this Mac runs a dozen parallel Blender sessions and Cycles is
# ~3 min a frame at load 270+. The A/B pass is a DIFFERENCE measurement — both
# sides get the identical rig and the same noise seed, so the sampling floor
# affects the absolute image, not the delta the gate reads.
