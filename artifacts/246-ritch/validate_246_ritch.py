"""Fresh-scene contract validation for 246-ritch.glb.

    blender -b --python validate_246_ritch.py -- [--glb FILE] [--out FILE]
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3958481, 37.7802253],
        "front_heading_deg_true": 45.0,
        "target_height_m": 18.76,
    ...
    results["checks"] = {
        "meters_and_plausible_dimensions": 18.5 <= dims.z <= 19.0
        and 27.0 <= dims.x <= 30.0
        and 27.0 <= dims.y <= 30.0,
        "crest_normalized_to_target": abs(mx.z - 18.76) <= 0.02,
