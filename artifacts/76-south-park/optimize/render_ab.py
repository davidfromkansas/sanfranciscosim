...
RES = (960, 720)
FOV_DEG = 40.0
AZIMUTH = math.radians(172.0)  # matched to this asset's review aerial: reads the
                               # street facade with its bay and arch, the 29.7 m
                               # depth, the exposed south-west flank band and the
                               # roof deck all in one frame
