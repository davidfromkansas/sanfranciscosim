...
# coplanar RING BANDS. This asset has two closed annuli that follow the whole
# 6.90 x 29.70 m footprint — `parapet` (13.08 -> 13.43 m) and `roof_rail` round
# the roof deck — plus long coplanar strips in the stone base, its two
# rustication grooves, the south-west flank band and the rear face.
# Re-triangulating an annulus ngon emits slivers up to the full 29.7 m length;
# they pass every area-based degeneracy test, collapse their shared vertex
...
# (precedent: 350-brannan, 13 Aug 2026; same call made on 106-south-park).
# At 4,376 triangles this step is worth a handful at most.
