"""Compose the review renders into asian-art-museum-contact-sheet.png."""
...
FONT = _font()
VIEWS = ["north", "east", "south", "west", "top", "aerial", "night", "night-larkin"]
COLS = 4
PAD = 40
LABEL_H = 56
CELL_W = 460
...
def load(view):
    img = Image.open(HERE / f"asian-art-museum-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "asian-art-museum-contact-sheet.png"
    sheet.save(out)
