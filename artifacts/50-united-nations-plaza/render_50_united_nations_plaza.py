"""Controlled review renders of the exported 50 United Nations Plaza GLB.

    blender -b --python render_50_united_nations_plaza.py --
        [--glb FILE] [--out DIR] [--prefix 50-united-nations-plaza]
...
RES = (1600, 900)  # landscape: the building is long and low
AER_RES = (1400, 1200)
TOP_RES = (1300, 1300)
...
def main():
    ...
    out = arg("--out", here)
    prefix = arg("--prefix", "50-united-nations-plaza")
    ...
    # --- top view: the courtyard, the C-shaped metal hip roof, the green roof
    ...
    # From the south-east: the colonnade, the scooped SE corner, the courtyard
    # and the north wing's green roof all in one view (style bible s.18).
...
def to_night(span):
    ...
    for mat in bpy.data.materials:
        ...
        bsdf.inputs["Emission Strength"].default_value = 2.4 if "white" in mat.name else 2.0
