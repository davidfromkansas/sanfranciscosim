"""Compose the review renders into 414-brannan-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"414-brannan-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "414-brannan-contact-sheet.png"
    sheet.save(out)
