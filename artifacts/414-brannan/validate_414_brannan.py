"""Fresh-scene contract validation for 414-brannan.glb.

    blender -b --python validate_414_brannan.py -- [--glb FILE] [--out FILE]
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3948685, 37.7799308],
    ...
    results["checks"] = {
        # 24.90 x 21.28 m at a 45.2 deg heading gives a ~33 x 33 m AABB; the
        # tile pent projects 0.68 m on two faces, which is the extra 0.3 m.
        "meters_and_plausible_dimensions": 13.8 <= dims.z <= 14.2
        and 32.0 <= dims.x <= 34.5
        and 32.0 <= dims.y <= 34.5,
