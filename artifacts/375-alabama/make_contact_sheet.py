"""Compose the review renders into 375-alabama-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"375-alabama-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "375-alabama-contact-sheet.png"
    sheet.save(out)
