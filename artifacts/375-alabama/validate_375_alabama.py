"""Fresh-scene contract validation for 375-alabama.glb.

    blender -b --python validate_375_alabama.py -- [--glb FILE] [--out FILE]
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.4118477, 37.7645633],
        "front_heading_deg_true": 265.7,
        "target_height_m": 22.5,
    ...
    results["checks"] = {
        "meters_and_plausible_dimensions": 22.3 <= dims.z <= 22.7
        and 65.0 <= dims.x <= 69.0
        and 59.0 <= dims.y <= 63.0,
        "crest_normalized_to_target": abs(mx.z - 22.5) <= 0.02,
