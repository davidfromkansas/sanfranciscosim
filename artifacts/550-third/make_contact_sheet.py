"""Compose the 550 Third Street review contact sheet from the rendered tiles.

    python3 make_contact_sheet.py [--dir DIR] [--prefix 550-third]
...
INK = (58, 53, 48)
TILES = [
    ("top", "TOP — roof plan (the primary facade)"),
    ("aerial", "AERIAL 3/4 — from the east, 40° down"),
    ("night", "NIGHT — penthouse lantern + skylights"),
...
def main():
    ...
    ap.add_argument("--prefix", default="550-third")
    args = ap.parse_args()
