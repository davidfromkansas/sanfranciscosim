"""Controlled review renders of the exported 181 South Park GLB.
    ...
    blender -b --python render_132_south_park.py -- [--glb FILE] [--out DIR]
                                                    [--prefix 132-south-park]
                                                    [--night] [--only VIEW]
                                                    [--samples N]
...
RES = (1200, 1200)   # square: a 45-deg lot whose AABB is 26.6 x 26.6 m
AER_RES = (1500, 1150)
TOP_RES = (1250, 1250)
...
def main():
    ...
    glb = arg("--glb", os.path.join(here, "132-south-park.glb"))
    out = arg("--out", here)
    prefix = arg("--prefix", "132-south-park")
    night = "--night" in argv
    only = arg("--only", None)
