...
report["gates"] = {
    ...
    # Per-asset adaptation: the gate exists to catch the OPTIMIZER flipping
    # windings, so it is measured as a delta against the same test on the input.
    # An asset with deliberately single-sided surfaces carries a standing
    # residual of its own; this one's input residual is measured, not assumed.
