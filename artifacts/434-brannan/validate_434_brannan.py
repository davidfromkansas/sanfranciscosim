"""Fresh-scene contract validation for 434-brannan.glb.

    blender -b --python validate_434_brannan.py -- [--glb FILE] [--out FILE]
...
def main():
    ...
    results = {
        ...
        "anchor_lonlat": [-122.3954103, 37.7796003],
        "front_heading_deg_true": 134.8,
        "target_height_m": 13.79,
    ...
    results["checks"] = {
        "meters_and_plausible_dimensions": 13.5 <= dims.z <= 14.1
        and 38.0 <= dims.x <= 42.0
        and 38.0 <= dims.y <= 42.0,
        "crest_normalized_to_target": abs(mx.z - 13.79) <= 0.02,
