"""Compose the review renders into 434-brannan-contact-sheet.png."""
...
def load(view):
    img = Image.open(HERE / f"434-brannan-{view}.png").convert("RGB")
    w = CELL_W
...
def main():
    ...
    out = HERE / "434-brannan-contact-sheet.png"
    sheet.save(out)
